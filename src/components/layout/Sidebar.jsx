...
function Sidebar({
    ...
    const { showFinancialActivity, showFileMakerExample, showCustomerForm, showTeamForm, sidebarMode } = useAppState();
    const { setShowFinancialActivity, setShowFileMakerExample, setShowCustomerForm, setShowTeamForm, setSidebarMode } = useAppStateOperations();
